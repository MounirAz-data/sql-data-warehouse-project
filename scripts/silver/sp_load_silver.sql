...
BEGIN
	...
	BEGIN TRY
        ...
        SELECT
            ...
            CAST(LEAD(prd_start_dt) OVER (PARTITION BY prd_key ORDER BY prd_start_dt)-1 AS DATE) AS prd_end_dt --Calculate end date as one day before price change
        ...
        SELECT
            ...
            CASE
                ...
                ELSE bdate
            END AS bdate, -- Set  future birthdates or irrealistic ones to NULL
            CASE
